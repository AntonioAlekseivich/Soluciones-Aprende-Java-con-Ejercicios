...
public class Administrador extends Persona {
	public static final String [] EJERCICIOS = {"piramide","tres_en_raya","dado"};
	...
	public static void applyPermissions(Usuario usuario, boolean[] permissions) throws SQLException {
        for (int i = 0; i < EJERCICIOS.length; i++) {
            switchPermiso(usuario, EJERCICIOS[i], permissions[i]);
        }
	}
	private static void switchPermiso(Usuario usuario, String column, boolean value) throws SQLException {
		int idUsuario = usuario.getId();
		DAOPersona.updatePermit(idUsuario,column,value);
	}
