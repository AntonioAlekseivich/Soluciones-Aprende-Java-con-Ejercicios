...
public class Usuario extends Persona {
	...
	// Att
	public static final int CANTIDAD_PERMISOS=3;
	private int idUsuario;
	private boolean baneado;
	private boolean[] permisos = new boolean [CANTIDAD_PERMISOS]; 
	...
	public static Usuario crearUsuario(int idUsuario, String nombre, String contrasenia, Boolean ban) {
		...
		usuarioAux.setPermisos(DAOPersona.getPermisosDAO(usuarioAux));//Le pillamos los permisos
